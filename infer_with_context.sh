...
if [[ $# -lt 1 ]]; then
    echo "Usage: sbatch infer_abstract.sh <zh|de|it>" >&2
    exit 1
fi
...
OUT_DIR=outputs/en-${TGT_LANG_CODE}/with-context/seg${SEGMENT_SIZE}_mss${MIN_START_SECONDS}_h${HISTORY_UTTERANCES}
